...
export interface DotPatternProps {
    ...
    waveSpeed?: number
    /** Vignette color gradient stop (rgba) */
...
export function DotPattern({
    ...
    glowIntensity = 1,
    waveSpeed = 0.5,
    vignetteColor = "rgba(10,10,10,0.6)",
}: DotPatternProps) {
    ...
    return (
        <div
            ref={containerRef}
            className={cn("fixed inset-0 overflow-hidden bg-background -z-50", className)}
        >
            ...
            <div
                ...
                style={{
                    background:
                        `radial-gradient(ellipse at center, transparent 0%, transparent 40%, ${vignetteColor} 100%)`,
                }}
            />
